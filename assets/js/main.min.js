    ...
    cart.forEach(item => {
        ...
        const itemHtml = `
            <div class="relative flex gap-3 bg-black/30 p-3 rounded-xl border border-white/5 items-center transition hover:border-brand-red/50 group">
                <button onclick="removeFromCart(${productId})" class="absolute top-2 left-2 z-10 p-1 text-gray-500 hover:text-brand-red hover:bg-brand-red/10 rounded-md transition" title="حذف از سبد">
                    <i data-lucide="x" style="width:16px;height:16px;"></i>
                </button>

                <a href="${productUrl}" class="w-14 h-14 bg-brand-dark rounded-lg flex items-center justify-center border border-white/10 text-brand-red flex-shrink-0 p-2 hover:scale-105 transition-transform">
                ...
                <div class="flex-1 min-w-0 pl-6"> 
                    <a href="${productUrl}" class="block transition-colors hover:opacity-80">
                        <h5 class="text-xs font-bold text-white truncate">${productName}</h5>
                    </a>
                    ...
                    <div class="flex items-center justify-between mt-2">
                        ...
                        <div class="flex items-center gap-2 bg-brand-grey border border-white/10 rounded-md px-2 py-0.5 text-xs">
                            <button class="text-gray-400 hover:text-white font-bold" onclick="changeQty(${productId}, 1)">+</button>
