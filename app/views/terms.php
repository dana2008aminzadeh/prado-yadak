...
<body class="bg-brand-dark text-white overflow-x-hidden antialiased">
    ...
    <main class="max-w-6xl mx-auto px-4 py-8 space-y-12">
        ...
        <div class="text-center space-y-4 py-6">
            <div
                class="inline-flex items-center gap-2 bg-[#eae0d6] border border-[#a88d7c]/50 text-[#2b170c] shadow-sm text-xs sm:text-sm font-bold px-4 py-1.5 rounded-full">
        ...
        <section class="bg-brand-grey border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 space-y-6">
            <div class="flex items-center gap-3 border-b border-white/10 pb-4">
                <div
                    class="w-10 h-10 bg-brand-red/10 border border-[#a88d7c]/20 rounded-xl flex items-center justify-center text-[#8b533a] shrink-0">
            ...
            <div class="space-y-4 text-xs sm:text-sm text-gray-300 leading-loose text-justify">
                ...
                <div
                    ...
                    <ul class="list-disc list-inside text-xs text-gray-200 space-y-4 pr-2 leading-loose">
                        <li>عودت کامل مبلغ پرداختی قطعه.</li>
                        <li>جبران کامل هزینه‌های رفت و برگشت پستی و ارسال کالا.</li>
                        <li>عذرخواهی رسمی و ارائه بن تخفیف ویژه برای خریدهای آتی.</li>
                    </ul>
                </div>
                ...
                <ul class="space-y-2.5 text-xs text-gray-300">
                    <li class="flex items-start gap-2.5 bg-brand-dark/40 p-3 rounded-xl border border-white/5">
                        ...
                        <span><strong class="text-white">هولوگرام و پلمپ کمپانی:</strong> تمامی قطعات جنیون پارت دارای
                            بارکد اختصاصی ۱۰ تا ۱۲ رقمی تویوتا و لیبل اصلی با چاپ لیزری پرکیفیت می‌باشند.</span>
                    </li>
                    <li class="flex items-start gap-2.5 bg-brand-dark/40 p-3 rounded-xl border border-white/5">
                        <i data-lucide="check-circle-2" class="w-4 h-4 text-emerald-500 shrink-0 mt-0.5"></i>
                    ...
                    <li class="flex items-start gap-2.5 bg-brand-dark/40 p-3 rounded-xl border border-white/5">
                        <i data-lucide="check-circle-2" class="w-4 h-4 text-emerald-500 shrink-0 mt-0.5"></i>
                        <span><strong class="text-white">ضمانت کتبی فاکتور:</strong> اصالت تمام قطعات خریداری‌شده به
                            صورت صریح و کتبی در مهر و فاکتور رسمی فروشگاه قید می‌گردد.</span>
                    </li>
                </ul>
            </div>
        </section>

        <!-- بخش ۲: شرایط ۷ روز مهلت بازگشت کالا -->
        <section class="bg-brand-grey border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 space-y-6">
            <div class="flex items-center gap-3 border-b border-white/10 pb-4">
                <div
                    class="w-10 h-10 bg-brand-red/10 border border-[#a88d7c]/20 rounded-xl flex items-center justify-center text-[#8b533a] shrink-0">
            ...
            <div class="space-y-4 text-xs sm:text-sm text-gray-300 leading-loose text-justify">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
                    ...
                    <div class="bg-brand-dark/60 border border-emerald-500/30 p-5 rounded-2xl space-y-3">
                        <span
                            class="text-emerald-500 font-bold text-xs flex items-center gap-2 pb-2 border-b border-emerald-500/20">
                            <i data-lucide="check-circle" class="w-4 h-4 text-emerald-500"></i> موارد مشمول مهلت بازگشت
                            کالا
                        </span>
                    ...
                    <div class="bg-brand-dark/60 border border-rose-500/30 p-5 rounded-2xl space-y-3">
                        <span
                            ...
                            <i data-lucide="x-circle" class="w-4 h-4"></i> شرایط ابطال مهلت بازگشت (غیرقابل مرجوعی)
                        </span>
                        <ul class="space-y-2 text-xs text-gray-300 list-disc list-inside">
                            <li>باز شدن پلمپ نایلونی، مخدوش شدن لیبل یا پاره شدن جعبه اصلی تویوتا.</li>
                ...
                <div
                    ...
                    <div>
                        <strong class="text-brand-red font-bold block mb-1">نکته بسیار مهم درباره قطعات برقی
                            تویوتا:</strong>
                        قطعات برقی تویوتا (نظیر ECU، سنسور اکسیژن، کوئل و سنسور ABS) به دلیل حساسیت بالا به نوسانات
                        ولتاژ سیم‌کشی خودرو، پس از باز شدن پلمپ پلاستیکی یا تست شدن روی خودرو، تحت هیچ شرایطی قابل
                        مرجوعی نمی‌باشند. لطفاً قبل از باز کردن پلمپ از عیب‌یابی دقیق برق‌کار مطمئن شوید.
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="bg-brand-grey border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 space-y-6">
            <div class="flex items-center gap-3 border-b border-white/10 pb-4">
                <div
                    class="w-10 h-10 bg-[#8b533a]/10 border border-[#8b533a]/20 rounded-xl flex items-center justify-center text-[#8b533a] shrink-0">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="bg-brand-red/10 border border-brand-red/30 rounded-xl p-4 space-y-2">
                        <div class="flex items-center justify-between">
                            <span class="font-bold text-xs text-brand-red flex items-center gap-1.5">
                                <i data-lucide="check" class="w-4 h-4"></i> اشتباه فروشگاه یا نقص فنی
                            </span>
                            <span
                                class="bg-brand-red text-white text-[9px] sm:text-[10px] font-bold px-2 py-0.5 rounded whitespace-nowrap shrink-0">۱۰۰٪
                                رایگان</span>
                        </div>
                    ...
                    <div class="bg-amber-500/10 border border-amber-500/30 rounded-xl p-4 space-y-2">
                        <div class="flex items-center justify-between">
                            <span class="font-bold text-xs text-amber-500 flex items-center gap-1.5">
                                <i data-lucide="user-x" class="w-4 h-4"></i> انصراف سلیقه‌ای یا اشتباه خریدار
                            </span>
                            <span
                                class="bg-amber-500/20 text-amber-500 text-[9px] sm:text-[10px] font-bold px-2 py-0.5 rounded border border-amber-500/40 whitespace-nowrap shrink-0">بر
                                عهده خریدار</span>
                        </div>
                        <p class="text-xs text-gray-300 leading-relaxed">
                            اگر خریدار پس از ارسال از خرید خود منصرف شود یا مشخصات خودرو را اشتباه اعلام کرده باشد،
                            هزینه رفت و برگشت مرسوله بر عهده خریدار محترم است.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <!-- بخش ۴: شرایط ارسال، حمل‌ونقل و تحویل کالا -->
        <section class="bg-brand-grey border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 space-y-6">
            <div class="flex items-center gap-3 border-b border-white/10 pb-4">
                <div
                    class="w-10 h-10 bg-brand-red/10 border border-[#a88d7c]/20 rounded-xl flex items-center justify-center text-[#8b533a] shrink-0">
            ...
            <div class="space-y-4 text-xs sm:text-sm text-gray-300 leading-loose text-justify">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 my-2">
                    ...
                    <div class="bg-brand-red/10 border border-brand-red/30 p-5 rounded-2xl space-y-2">
                        <div class="flex items-center gap-2 text-brand-red font-bold text-xs">
                            <i data-lucide="shield-check" class="w-4 h-4"></i>
                            <strong>تحویل با بیمه غرامت کالا:</strong>
                        </div>
                        <p class="text-gray-300 text-xs leading-relaxed">
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2 text-amber-500 font-bold text-xs">
                                ...
                                <strong>مسئولیت رویت هنگام تحویل کالا:</strong>
                            </div>
                            <span
                                class="bg-amber-500 text-black text-[10px] font-black px-2 py-0.5 rounded animate-pulse">اقدام
                                ضروری</span>
                        </div>
                        <p class="text-gray-200 text-xs leading-relaxed">
                            خریدار موظف است <strong>دقیقاً در لحظه دریافت بسته از مامور پست یا تیپاکس</strong>، سلامت
                            فیزیکی کارتن را بررسی نماید. در صورت مشاهده هرگونه شکستگی، پارگی یا لهیدگی شدید، حتماً از
                            تحویل بسته خودداری کرده و از مامور <strong class="text-white underline">«صورت‌جلسه آسیب
                                فیزیکی»</strong> دریافت کنید.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <!-- بخش ۵: سوالات متداول قوانین و بازگشت کالا (FAQ) -->
        <section class="bg-brand-grey border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 space-y-6">
            <div class="flex items-center gap-3 border-b border-white/10 pb-4">
                <div
                    class="w-10 h-10 bg-brand-red/10 border border-[#a88d7c]/20 rounded-xl flex items-center justify-center text-[#8b533a] shrink-0">
            ...
            <div class="space-y-3" id="faq-accordion">
                ...
                <div
                    ...
                    <button onclick="toggleFaq(this)"
                        class="w-full p-4 text-right flex items-center justify-between font-bold text-xs sm:text-sm text-black transition bg-white">
                        <span class="flex items-center gap-2">
                            <i data-lucide="help-circle" class="w-4 h-4 text-black shrink-0"></i>
                            چگونه مطمئن شوم قطعه انتخابی دقیقاً به تویوتا من می‌خورد؟
                        </span>
                        <i data-lucide="chevron-down"
                            class="w-4 h-4 transition-transform duration-300 shrink-0 text-black"></i>
                    </button>
                ...
                <div
                    ...
                    <button onclick="toggleFaq(this)"
                        ...
                        <span class="flex items-center gap-2">
                            <i data-lucide="help-circle" class="w-4 h-4 text-black shrink-0"></i>
                            اگر قطعه در تعمیرگاه روی خودرو نصب شد ولی مشکل حل نشد چه باید کرد؟
                        </span>
                        <i data-lucide="chevron-down"
                            class="w-4 h-4 transition-transform duration-300 shrink-0 text-black"></i>
                    </button>
                    <div class="grid grid-rows-[0fr] opacity-0 transition-all duration-300 ease-in-out">
                        <div class="overflow-hidden">
                            <div
                                class="p-4 text-xs sm:text-sm text-black font-medium leading-loose border-t border-gray-200 bg-gray-50">
                                طبق قوانین صنف لوازم یدکی، قطعاتی که آثار بسته شدن، پیچ شدن یا استفاده شدن روی خودرو را
                                دارند قابل بازگشت نیستند؛ زیرا عیب‌یابی نادرست تعمیرکار مربوط به تشخیص خودرو بوده و قطعه
                                سلامت کامل دارد.
                            </div>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <button onclick="toggleFaq(this)"
                        ...
                        <span class="flex items-center gap-2">
                            <i data-lucide="help-circle" class="w-4 h-4 text-black shrink-0"></i>
                            پس از ثبت مرجوعی، پول خریدار چه زمانی عودت داده می‌شود؟
                        </span>
                        <i data-lucide="chevron-down"
                            class="w-4 h-4 transition-transform duration-300 shrink-0 text-black"></i>
                    </button>
                    <div class="grid grid-rows-[0fr] opacity-0 transition-all duration-300 ease-in-out">
                        <div class="overflow-hidden">
                            <div
                                class="p-4 text-xs sm:text-sm text-black font-medium leading-loose border-t border-gray-200 bg-gray-50">
                                بلافاصله پس از رسیدن بسته به انبار مرکزی پرادو یدک و تایید سلامت فیزیکی کارتن و کالا،
                                حداکثر ظرف مدت ۲۴ تا ۴۸ ساعت کاری، کل مبلغ فاکتور به شماره شبا یا کارت اعلامی خریدار
                                واریز می‌گردد.
                            </div>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <button onclick="toggleFaq(this)"
                        ...
                        <span class="flex items-center gap-2">
                            <i data-lucide="help-circle" class="w-4 h-4 text-black shrink-0"></i>
                            آیا ضمانت اصالت جنیون پارت کتبی است؟
                        </span>
                        <i data-lucide="chevron-down"
                            class="w-4 h-4 transition-transform duration-300 shrink-0 text-black"></i>
                    </button>
                    <div class="grid grid-rows-[0fr] opacity-0 transition-all duration-300 ease-in-out">
                        <div class="overflow-hidden">
                            <div
                                class="p-4 text-xs sm:text-sm text-black font-medium leading-loose border-t border-gray-200 bg-gray-50">
                                بله، عبارت "اصلی جنیون پارت با ضمانت کتبی مرجوعی و اصالت" به صورت صریح در فاکتور رسمی
                                سایت پرادو یدک صادر شده همراه با مهر فروشگاه درج می‌شود.
                            </div>
                        </div>
                    </div>
                </div>
