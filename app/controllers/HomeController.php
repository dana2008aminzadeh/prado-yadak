    ...
    public function terms()
    {
        ...
        $faqs = [
            [
                ...
                'a' => 'کافیست شماره ۱۷ رقمی شاسی خودرو (کد VIN درج شده روی کارت ماشین) را از طریق واتساپ یا تماس تلفنی به کارشناسان پرادو یدک اعلام کنید. کارشناسان ما شماره فنی (OEM) قطعه را با این کد تطبیق می‌دهند تا احتمال خطای خرید به حداقل برسد؛ در صورت اثبات عدم اصالت نیز وجه پرداختی طبق ضوابط بازگشت کالا عودت داده می‌شود.'
            ],
            [
